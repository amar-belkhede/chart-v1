...
import "./CarsScatterPlot.css";

class CarsScatterPlot extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div class="carScatter">
                <svg className="carMargin" width={800} height={500}></svg>
            </div>
        );
    }
}

export default CarsScatterPlot;
