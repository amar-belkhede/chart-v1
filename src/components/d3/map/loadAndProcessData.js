...
export const loadAndProcessData = () =>
    Promise.all([
        csv(
            "https://gist.githubusercontent.com/curran/e7ed69ac1528ff32cc53b70fdce16b76/raw/61f3c156efd532ae6ed84b38102cf9a0b3b1d094/data.csv"
        ),
        ...
        const featuresWithPopulation = countries.features
            ...
            .map((d) => {
                d.properties["2018"] =
                    +d.properties["2018"].replace(/ /g, "") * 1000;
                return d;
            });
